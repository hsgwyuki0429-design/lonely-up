...
class Sfx {
  ...
  // バウンドブロックの跳ね返り (弾む「ボヨン」)。上昇スライドでバネ感を出す。
  bounce() {
    this.blip(220, 0.16, 'sine', 0.07, 620);      // 低音から一気に駆け上がる主音
    this.blip(440, 0.12, 'triangle', 0.035, 900); // 明るい倍音レイヤー
    this.noise(0.04, 0.014, 1600, 1.6);           // 「ボインッ」の摩擦感
  }
